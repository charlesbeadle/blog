...
<body class="bg-gray-100 text-gray-600 min-h-screen flex flex-col justify-between font-mono">
  ...
  <div>
    ...
    <main class="mx-auto w-11/12 max-w-screen-2xl xl:w-2/3 pb-10">
      <section class="mt-24 mb-10 sm:mb-16 lg:mb-20 xl:mb-24 mx-auto 2xl:mx-0 w-full md:w-3/4 lg:w-3/5 xl:w-3/4 2xl:w-full flex flex-col lg:flex-row"><!-- About me section with socials -->
        ...
        <div class="mb-5 w-full flex flex-col">
          <h1 class="mb-3 xl:mb-4 2xl:mb-6 text-xl sm:text-2xl 2xl:text-5xl font-bold text-gray-700">Welcome!</h1>
      ...
      <div class="flex justify-between">
        <section class="mx-auto 2xl:mx-0 w-full md:w-3/4 lg:w-3/5 xl:w-3/4 2xl:w-3/5"><!-- Posts section -->
          <div class="pt-[5px] mb-6 flex justify-between w-full">
            <h2 class="text-xl sm:text-2xl text-gray-700 font-bold block leading-none">Recent Posts</h2>  
            <a href="/topics" class="hidden md:block px-3 py-2 font-bold text-gray-600 border-2 border-gray-600 rounded leading-none">
              Browse All
